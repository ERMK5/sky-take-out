...
public class OrderController {
    ...
    public Result<PageResult> page(@RequestParam(defaultValue = "1") int pageNum, @RequestParam(defaultValue = "10") int pageSize, Integer status) {
        log.info("分页查询历史订单，页面{}，每页记录数{}，订单状态{},", pageNum, pageSize, status);
